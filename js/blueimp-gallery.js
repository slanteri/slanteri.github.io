...
(function (factory) {
	...
	support: (function (element) {
	    ...
	    var text = this.slides[index].firstChild.subtitle,
		subtitleElement = this.subtitleElement;
	    if (subtitleElement.length) {
		this.subtitleElement.empty();
		if (text) {
		    subtitleElement[0].appendChild(document.createTextNode(text));
		}
	    }
	},
        ...
        initWidget: function () {
            ...
            this.subtitleElement = this.container.find(
                this.options.subtitleElement
            ).first();
            if (this.num === 1) {
